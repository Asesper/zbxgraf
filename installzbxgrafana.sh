...
toilet -w 100 -f smmono9 Install | lolcat
...
figlet -w 100 -f smmono9 "Creando BD" | lolcat
figlet -w 100 -f smmono9 "Aguarde por favor"  | lolcat
...
sed -i 's/# php_value date.timezone Europe\/Riga/php_value date.timezone America\/Montevideo/g' /etc/apache2/conf-enabled/zabbix.conf
...
figlet -w 100 -f smmono9 "Configurando" | lolcat
cd /usr/share/snmp/mibs
git clone https://github.com/bzerves/vendors.git
...
clear
echo -e "\n\tZabbix: http://$ip/zabbix \tUsuario: Admin - Clave: zabbix \n\tGrafana: http://$ip:3000 \tUsuario: admin - Clave: admin \n\tLogs: http://$ip:6688 \tUsuario: aluno - Clave: logs" | boxes -d spring -a hc -p h8 |lolcat  
cowsay -f tux "En el asistente de Zabbix, haga clic en siguiente en todos los pasos sin cambiar nada, ¡ni siquiera la información de MYSQL!" | lolcat
#lvresize -t -v -l +100%FREE /dev/mapper/ubuntu–vg-ubuntu–lv
#lvresize -v -l +100%FREE /dev/mapper/ubuntu–vg-ubuntu–lv
#resize2fs -p /dev/mapper/ubuntu–vg-ubuntu–lv
toilet -w 100 -f mini FIN. | lolcat
